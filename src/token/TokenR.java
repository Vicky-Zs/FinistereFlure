...
public class TokenR extends Token{
  ...
  public boolean canBePushByPion(int direction){
    switch(direction){
      case 0:
      return(this.myGame.getMap(this.posX, this.posY+1).isTokenHere()==false
      || this.myGame.getMap(this.posX, this.posY).getWall(direction)==false);
      case 1:
      return(this.myGame.getMap(super.posX+1, super.posY).isTokenHere()==false
      || this.myGame.getMap(this.posX, this.posY).getWall(direction)==false);
      case 2:
      return(this.myGame.getMap(this.posX, this.posY-1).isTokenHere()==false
      || this.myGame.getMap(this.posX, this.posY).getWall(direction)==false);
      case 3:
      return(this.myGame.getMap(this.posX-1, this.posY).isTokenHere()==false
      || this.myGame.getMap(this.posX, this.posY).getWall(direction)==false);
      default:
      return false;
    }
